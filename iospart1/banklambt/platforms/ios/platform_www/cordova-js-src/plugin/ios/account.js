   ...
   if(email == userEmail){
     ...
     console.log("transfer function called.....");
         if(transferFrom == "currentAccount" && transferTo =="creditAccount"){
           ...
           else if(amountToTransfer>currentAccountBalance&&amountToTransfer>0){
             creditAccountBalance=currentAccountBalance+creditAccountBalance;
             userData["currentAccountBalance"]=0;
